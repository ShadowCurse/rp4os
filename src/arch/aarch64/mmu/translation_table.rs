...
impl<const NUM_TABLES: usize> FixedSizeTranslationTable<NUM_TABLES> {
    ...
    pub const fn _new(precompute: bool) -> Self {
...
impl TryFrom<InMemoryRegister<u64, STAGE1_PAGE_DESCRIPTOR::Register>> for AttributeFields {
    ...
    fn try_from(
        ...
        let mem_attributes = match desc.read(STAGE1_PAGE_DESCRIPTOR::AttrIndx) {
            crate::memory::mmu::arch_mmu::mair::NORMAL => MemAttributes::CacheableDRAM,
            crate::memory::mmu::arch_mmu::mair::DEVICE => MemAttributes::Device,
    ...
    for FixedSizeTranslationTable<NUM_TABLES>
{
    fn init(&mut self) -> Result<(), &'static str> {
        ...
        for (lvl2_nr, lvl2_entry) in self.lvl2.iter_mut().enumerate() {
            ...
            let phys_table_addr =
                crate::memory::mmu::try_kernel_virt_addr_to_phys_addr(virt_table_addr)?;
